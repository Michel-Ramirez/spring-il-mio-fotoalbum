...
public class SpringIlMioFotoalbumApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Picture foto1 = new Picture("Bliss",
				...
				"https://www.resetdigitale.it/img/cms/5de0dcc3d868f064786593.jpg", false, user1, cat3, cat5);
		Picture foto2 = new Picture("Lunch atop a Skyscraper",
				...
				"https://www.fotografidigitali.it/i/n/usa_2_720.jpg", true, user1, cat9, cat5);
		...
		Picture foto7 = new Picture("The Falling Man",
				...
				"https://qph.cf2.quoracdn.net/main-qimg-da9da48ed4e1b6e19412eab690e0c141-lq", true, user1, cat6, cat5);
		Picture foto8 = new Picture("Tank Man",
				...
				"https://www.weshoot.it/blog/wp-content/uploads/2018/02/0000000.jpg", true, user1, cat7);
		Picture foto9 = new Picture("Napalm Girl",
				...
				"https://www.lasecondaguerramondiale.org/images/foto_seconda_guerra_mondiale_2.jpg", true, user1, cat8,
				cat4);
